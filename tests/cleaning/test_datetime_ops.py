...
def test_str_to_datetime():
    ...
    """
    date = datetime_ops.parse_date_string("2022-10-10")
...
def test_str_to_datetime_format():
    ...
    """
    date = datetime_ops.parse_date_string("10/10/2022", format="%m/%d/%Y")
    assert isinstance(date, datetime.datetime)
...
def test_str_to_datetime_formatlist():
    ...
    """
    date = datetime_ops.parse_date_string("10-10-2022", format=["%m/%d/%Y", "%m-%d-%Y"])
    assert isinstance(date, datetime.datetime)
...
def test_str_to_datetime_incorrect_format():
    ...
    date = datetime_ops.parse_date_string("10/10/2022")
...
def test_nonstring_to_datetime():
    ...
    date = datetime_ops.parse_date_string(None)
    assert np.isnan(date)
...
def test_nonstring_to_datetime_return_str():
    ...
    """
    date = datetime_ops.parse_date_string(None, error_value="None")
    assert date == "None"
...
def test_datetime_to_year():
    ...
    date = datetime_ops.parse_date_string("2022-10-10")
    year = datetime_ops.get_date_part(date)
    assert year == 2022
...
def test_datetime_to_month():
    ...
    date = datetime_ops.parse_date_string("2022-10-22")
    month = datetime_ops.get_date_part(date, date_part="month")
    assert month == 10
